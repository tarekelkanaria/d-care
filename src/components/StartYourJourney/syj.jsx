export default function StartYJ() {
  return (
    <>
      {/*main div*/}
      <section className="bg-cta text-white rounded-xl w-auto p-4 sm:p-20 flex flex-col items-center text-center justify-center gab-6   ">
        {/*header div*/}
        ...
        <div className="text-sm sm:text-base text-blue-100 max-w-xl font-light leading-relaxed ">
          <p>
            Join thousands of happy patients and experience the d-care
            difference.<br></br>
